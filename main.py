...
if __name__ == "__main__":
    ...
    parser.add_argument("--model_id", type=str, default="microsoft/Florence-2-large", help="Model ID")
    ...
    parser.add_argument("--input_image_filepath", type=str, required=True, help="Path to the input image")
    ...
    image_captioner.infer(
        input_image_filepath=None if args.input_image_filepath == "None" else args.input_image_filepath,
        prompt=prompt,
